...
import { Switch, Input, Code } from "@heroui/react";
import {
  CircleHelp,
  ChevronDown,
  ChevronUp,
      ...
      <div className="flex flex-col gap-6 w-full max-w-lg">
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <Tooltip
                    content={
                      <>
                        <div>
                          AI-powered parsing with OCR, plus image and table
                          extraction.
                        </div>
                        <div className="font-semibold mt-1">
                          Default mode, no need to set anything on API.
                        </div>
                        <div className="mt-2">
                          Set
                          <Code color="primary">
              ...
              <div className="flex items-center gap-2 mb-1">
                ...
                <Tooltip
                  content={
                    <>
                      <div>
                        A comma separated string listing the page to be
                        extracted. By default, all pages will be extracted.
                        Pages are numbered starting at 0.
                      </div>
                      <div className="mt-2">
                        Set
                        <Code color="primary">target_pages=&quot;$value</Code>
                        on API.
                      </div>
                    </>
                  }
        ...
        <div className="border rounded-lg">
          ...
          {isJobOptionsOpen && (
            <div className="px-4 pb-4 flex flex-col gap-4">
              <div className="text-xs text-gray-500">
                Agentic Document Understanding keeps results cached for 48 hours
                after upload.
              </div>
              <div className="flex items-center gap-2">
                ...
                <Tooltip
                  content={
                    <>
                      If the &quot;Do not cache&quot; option is selected,
                      Intelligent Document Understanding will not cache the
                      results of the document parsing. This means that if the
                      document is re-uploaded, parsing will be done from
                      scratch, which will incur fresh billing charges.
                      <div className="mt-2">
                        Set <Code color="primary">do_no_cache=True</Code> on
                        API.
                      </div>
                    </>
                  }
