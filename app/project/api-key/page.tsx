...
export default function APIKeyPage() {
  const KeyCreateModal = (
    <div>
      <div>
        {" "}
        Create a new API key to access our services. Make sure to copy your new
        ...
        <div className="w-full mx-auto">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center border-b py-5 mb-5 gap-4">
            <div className="flex items-center gap-3">
              <div>
                <div className="flex flex-row gap-1 items-center">
                  <KeyRound className="font-semibold" size={35} />
                  <div
                    className={subtitle({
                      size: "lg",
                      class:
            ...
            <div className="flex flex-row gap-2 mt-4 md:mt-0">
              <ModalComponent
                buttonAction="Create Key"
                buttonColor="primary"
                buttonName="Generate New Key"
                buttonVariant="solid"
                modalContent={KeyCreateModal}
