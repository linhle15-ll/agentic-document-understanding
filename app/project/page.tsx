...
function Card({ name, description, icon, documentation, playground }: CardProps) {
  return (
...
const features = [
  {
    title: "Parse",
    descriptions: "Parse your documents into tables and images to connect them to LLM",
  ...
  {
    title: "Extraction",
    descriptions: "Provide your documents, define the schema and extract the information",
