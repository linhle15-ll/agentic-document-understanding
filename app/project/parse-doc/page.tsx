...
export default function ParseDocPage() {
  ...
  const CodeSnippet = (
    <div className="flex flex-col gap-2"> This is the CODE SNIPPET </div>
  )
  return (
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center border-b py-5 mb-5 gap-4">
            ...
            <div className="flex flex-row gap-2 mt-4 md:mt-0">
              ...
              <Button variant="solid" radius="full" color="primary">
                ...
                {/* <ModalComponent modalTitle="Code snippet" modalContent={CodeSnippet} buttonVariant="solid" buttonColor="primary" buttonAction="OK" /> */}
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-5">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <div className="relative flex flex-col gap-3 min-w-screen mt-8 text-md font-semibold justify-center text-center px-2 w-full">
              ...
              <ModalComponent modalTitle="Example files" modalContent={ExampleFiles} buttonName="Example files" buttonVariant="bordered" buttonColor="primary" buttonAction="OK" />
            </div>
          </div>
        </div>
      </div>
